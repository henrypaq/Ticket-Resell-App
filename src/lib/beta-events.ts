...
export const BETA_EVENTS: BetaEvent[] = [
  ...
  },
  {
    ...
    venue: "Le Belmont",
    city: "Montreal",
    blurb: "Thursday nights at Belmont — join the waitlist or let us know you've got an extra.",
    flyerUrl: "/flyers/belmont.svg",
    days: ["Thursday"],
    supported: true,
  },
  {
    ...
    venue: "Stereo",
    city: "Montreal",
    blurb: "Weekend Stereo — Friday and Saturday. We'll ping you when a ticket drops.",
    flyerUrl: "/flyers/sous-sol.svg",
